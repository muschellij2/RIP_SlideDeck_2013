...
title: 'Computational Methods for Neuroimaging in R: Stroke Hemorrhages and X-ray Computed
  Tomography Scanning'
author: "John Muschelli, PhD - Johns Hopkins Bloomberg School of Public Health<br/> http://johnmuschelli.com/Genentech_Talk.html"
date: "April 13, 2016"
output:
...
```{r pander_nihss_mat, results='asis'}
pander(mat)
```
...
```{r cranlogs, cache = TRUE, eval = FALSE}
if (!require(cranlogs)) {
  library(devtools)
...
```{r dt_cranlogs, results = "asis", eval = FALSE, dependson = "cranlogs"}
